...
tek::parser::Parser::Parser(tek::parser::Parser::TokensVec tokens)
    : tokens{std::move(tokens)}, current{0} {}

tek::parser::Parser::ExpressionPtr tek::parser::Parser::expression() {
...
tek::parser::Parser::ExpressionPtr tek::parser::Parser::equality() {
    ...
    while (match({tokenizer::TokenType::BANG_EQUAL,
                  tokenizer::TokenType::EQUAL_EQUAL})) {
...
tek::parser::Parser::ExpressionPtr tek::parser::Parser::comparison() {
    ...
    while (this->match(
        {tokenizer::TokenType::GREATER, tokenizer::TokenType::GREATER_EQUAL,
         tokenizer::TokenType::LESS, tokenizer::TokenType::LESS_EQUAL})) {
        const auto op = this->previous();
...
tek::parser::Parser::ExpressionPtr tek::parser::Parser::factor() {
    ...
    while (this->match(
        {tokenizer::TokenType::SLASH, tokenizer::TokenType::STAR})) {
        const auto op = this->previous();
...
tek::parser::Parser::ExpressionPtr tek::parser::Parser::unary() {
    if (this->match(
            {tokenizer::TokenType::BANG, tokenizer::TokenType::MINUS})) {
        const auto op = this->previous();
        auto right = this->unary();
...
bool tek::parser::Parser::match(
    const std::vector<tokenizer::TokenType>& types) {
...
bool tek::parser::Parser::is_at_end() {
    return this->peek().type == tokenizer::TokenType::ENDOF;
}
...
tek::tokenizer::Token tek::parser::Parser::peek() {
    return this->tokens.at(this->current);
}

tek::tokenizer::Token tek::parser::Parser::previous() {
    return this->tokens.at(this->current - 1);
}

tek::tokenizer::Token
tek::parser::Parser::consume(const tokenizer::TokenType& type,
...
void tek::parser::Parser::synchronize() {
    ...
    while (!this->is_at_end()) {
        if (this->previous().type == tokenizer::TokenType::SEMICOLON) {
            return;
        }
