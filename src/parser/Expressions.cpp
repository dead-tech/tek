...
std::string BinaryExpression::accept(Visitor<std::string> &visitor) { return visitor.visit_binary_expression(*this); }
...
types::Literal GroupingExpression::accept(Visitor<types::Literal> &visitor)
{
    return visitor.visit_grouping_expression(*this);
}
...
std::string LiteralExpression::accept(Visitor<std::string> &visitor) { return visitor.visit_literal_expression(*this); }
...
std::string    UnaryExpression::accept(Visitor<std::string> &visitor) { return visitor.visit_unary_expression(*this); }
